...
<body class="bg-gray-100 flex flex-col min-h-screen">  
    ...
    <main class="container mx-auto mt-8 flex-grow flex items-center justify-center">  
        <section class="bg-white p-6 rounded-lg shadow-md w-full max-w-sm">  
            <h2 class="text-xl font-semibold mb-4 text-center">Sesión Administrador</h2>  
            <?php  
            session_start();  
            $error_message = '';  
            ...
            <?php endif; ?>  
            <form action="LOGON_ADMIN.php" method="POST">  
                <div class="mb-4">  
                ...
                <div class="mb-4">  
                    ...
                    <input type="password" id="contrasena" name="contrasena" class="mt-1 block w-full p-2 border border-gray-300 rounded" required />  
                </div>  
                <button type="submit" class="w-full bg-blue-600 text-white p-2 rounded hover:bg-blue-700 transition">Iniciar Sesión</button>  
            </form>  
            <p class="mt-4 text-center">  
                <a href="LOGOND.html" class="text-blue-600 hover:underline">¿No tienes una cuenta? Regístrate aquí</a>  
            </p>  
